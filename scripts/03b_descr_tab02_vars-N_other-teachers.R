...
## Pull data
excel_table <- read.xlsx(excel_file, sheet = "vars_tabulation_other_ed") %>% head(-1)
...
writeData(excel_file, sheet = "vars_tabulation_other_ed", excel_table)
